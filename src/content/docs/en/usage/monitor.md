...
## 3.11.1. Machine Monitor {#machine-monitor}
...
:::note[Note]
The Availability shown on the page is the cumulative availability over the monitoring period (see [3.5.3. OEE Monitoring Settings](/en/usage/tasks/#oee-monitor)). The availability plotted in the availability trend chart is calculated per bucket, using 5-minute buckets within the trend time window.
