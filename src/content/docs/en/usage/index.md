...
To switch the gateway off, use the **Shutdown/Restart Gateway** function button in the top right of the gateway management [Home](/en/usage/home/) page, and unplug the power cable only after the gateway's power LED has gone out.
