...
## 3.12.1. Common Functions {#function-buttons}

### 3.12.1.1. Change Password {#change-password}
...
#### 3.12.1.3.2. User Security Settings {#user-security}
...
**Authorized APIs** specifies which interfaces the user may call; see [4.2.7. Protected API and Authorized APIs](/en/reference/command-format/#protected-api) for how to set them.
...
#### 3.12.1.3.3. Edit User {#edit-user}
...
#### 3.12.1.3.4. Delete User {#delete-user}
...
## 3.12.2. Options {#advanced-options}
...
### 3.12.2.4. Remote Assistance {#remote-assist}
...
### 3.12.2.5. LAN2 Settings {#lan2-settings}

The "LAN2 Settings" switch shows or hides the LAN2 settings on the **Network** page; it is off by default. With the switch on, you can change the LAN2 settings on the **Network** page, following the same steps used for LAN1 in [3.7.1. Wired Network](/en/usage/network/#wired).
...
### 3.12.2.6. Security Control {#security-control}
...
### 3.12.3.1. Local Time {#local-time}

"Local Time" shows the gateway's current time.

### 3.12.3.2. Switch Language {#switch-language}
...
### 3.12.3.3. Time Server Address {#time-server}
