...
## 3.5.1. Machine Task Interval Settings {#machine-intervals}

"Machine Task Interval Settings" sets the automatic collection interval for each of the machine tasks described in [3.3.1.2. Task Settings](/en/usage/machines/#task-settings). Intervals are in milliseconds and all default to 5000 ms.
...
"OEE Monitoring (ms)" in the screenshot above is the automatic collection interval for machine OEE data; see [4.1.1. Machine OEE Data](/en/reference/glossary/#machine-oee).
...
## 3.5.2. Group Task Interval Settings {#group-intervals}

"Group Task Interval Settings" sets the automatic collection interval for each of the group tasks described in [3.4.1.2. Group Task Settings](/en/usage/groups/#group-tasks). Intervals are in milliseconds and all default to 5000 ms.

![Group Task Interval Settings](/img/manual/en/tasks/group-intervals.png)

"Count (ms)" in the screenshot above is the automatic collection interval for the group part count; see [4.1.3. Group Part Count](/en/reference/glossary/#group-count). "OEE Monitoring (ms)" is the automatic collection interval for group OEE data; see [4.1.2. Group OEE Data](/en/reference/glossary/#group-oee).

When you are done, click the **Save** button at the bottom of the page, then click **Restart Service** on Home to apply the changes.

## 3.5.3. OEE Monitoring Settings {#oee-monitor}

"OEE Monitoring Settings" defines the monitoring period and the availability formula used for machine OEE (see [4.1.1. Machine OEE Data](/en/reference/glossary/#machine-oee)) and group OEE (see [4.1.2. Group OEE Data](/en/reference/glossary/#group-oee)).
...
## 3.5.4. Tool Life Monitoring Settings {#toollife-monitor}
...
## 3.5.5. Count Monitoring Settings {#count-monitor}
...
"Monitor Mode" offers "Scheduled Reset" and "Time Window"; the default is "Scheduled Reset" with a default reset time of 00:00. For a description of the two modes, see [3.5.3. OEE Monitoring Settings](#oee-monitor).
...
## 3.5.6. Overload Monitoring Settings {#overload-monitor}
...
## 3.5.7. Alarm Monitoring Settings {#alarm-monitor}
...
### 3.5.7.1. Alarm Mapping Files {#alarm-mapping-files}
...
After uploading a mapping file, go to [Machines](/en/usage/machines/), open the "Alarm" task settings of the machine concerned, enable alarm mapping and select the file; see [3.3.1.2.6. Alarm Mapping](/en/usage/machines/#alarm-mapping).

## 3.5.8. Machine Status Monitoring Settings {#status-monitor}
...
## 3.5.9. Task Manager Settings {#task-manager}
