...
## 6.1. The LAN Port IP Address Shown on the Gateway's Network Page Does Not Match the Actual Setting {#lan-ip-mismatch}
...
## 6.2. A Brief Power Trip Causes the Gateway to Fail to Restart Automatically {#power-flap}
...
## 6.3. The Gateway Is Connected to Several Networks and One Is Restricted, So It Cannot Reach the Internet {#multi-network}
...
## 6.4. LAN1 and LAN2 on the Same Subnet Cause a Subnet Conflict and Communication Failure {#lan-segment-conflict}
